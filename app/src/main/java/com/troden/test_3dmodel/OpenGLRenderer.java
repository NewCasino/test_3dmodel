...
public class OpenGLRenderer implements Renderer 
{
	...
	public OpenGLRenderer (Context context, Handler handler)  
	{
		...
		model = new Model (R.raw.willis, mContext);
...
//		Log.i(DEBUG_TAG, "onsurfaceChanged()");
		...
		model.loadBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.skyscrapper));
	}
	...
	public void onDrawFrame (GL10 gl) 
	{
		...
		// Draw the rectangle
		gl.glLoadIdentity();
		gl.glTranslatef(0, -7, -65);
		gl.glRotatef(drawangle1, 0, 1, 0);
        gl.glScalef(0.3f, 0.3f, 0.3f);
